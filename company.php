					...
					<div class="row">
							...
							<div class="col-md-10 col-md-offset-1">
								...
								<div class="company-detail-wrapper">
                                    ...
                                    foreach($result as $row)
                                    {
									$post_date = DateTime::createFromFormat('d-m-y', $row['closing_date']);
                                    $post_month = DateTime::createFromFormat('d-m-y', $row['closing_date']);
                                    $post_year = DateTime::createFromFormat('d-m-y', $row['closing_date']);
									$type = $row['type'];
									if ($type == "Freelance") {
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Nigh Jobs</h5>
