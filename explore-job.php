...
$last_date = DateTime::createFromFormat('d/m/Y', $closingdate, new DateTimeZone('Europe/Paris'));
$post_date = DateTime::createFromFormat('d-m-y', $closingdate);
$post_month = DateTime::createFromFormat('d-m-y', $closingdate);
$post_year = DateTime::createFromFormat('d-m-y', $closingdate);
								...
								<div class="job-detail-header text-center">
									...
									<ul class="meta-list clearfix">
										...
										<li>
											...
											<?php echo "$post_date"; ?> <?php echo "$post_date"; ?>, <?php echo "$post_year"; ?>
										</li>
										<li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About NightJobs</h5>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Night Jobs Contact</h5>
								
								<p>Address : Algeria, constantine, university</p>
								<p>Email : <a href="mailto:imadlampard08@gmail.com">imadlampard08@gmail.com</a></p>
								<p>Phone : <a href="tel:+213778400672">+213 778 400 672</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Night jobs Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Night jobs</a></li>
								</ul>
