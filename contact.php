...
<head>
	...
	<title>Night Jobs - Contact Us</title>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Algeria, <br/> Constantine, <br/>University</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:imadlampard08@gmail.com">imadlampard08@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+213 778 400 672">+213 778 400 672</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : Algeria, Constantine</p>
